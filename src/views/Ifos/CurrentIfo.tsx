...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@weedfarm-libs/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://exchange.weedfarm.finance/#/swap" mr="16px">
              {TranslateString(999, 'Buy CAKE')}
            </LinkExternal>
            <LinkExternal href="https://exchange.weedfarm.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
          ...
          <Text as="div" pt="16px">
            <Button
              as="a"
              variant="secondary"
              href="https://docs.weedfarm.finance/core-products/ifo-initial-farm-offering"
            >
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with weedfarm, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
