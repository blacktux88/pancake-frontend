...
You can start by reading our [Contribution guidelines](https://docs.weedfarm.finance/code/contributing) first.
...
Translation in crowdin: `%asset% Earned` [link](https://crowdin.com/translate/weedfarm/8/en-de#330)
